                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () =>
                            ref.read(statusRequestsViewModelProvider(status).notifier).refresh(),
...
class _PaymentBubbleCardState extends ConsumerState<_PaymentBubbleCard> {
  ...
  void initState() {
    ...
    if (widget.shipment.invoice == null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(shipmentDetailViewModelProvider(widget.shipment).notifier).fetchInvoice();
      });
    }
  }
  ...
  void _showPaymentMethodSelector(BuildContext context, ShipmentDetailViewModel viewModel) {
  ...
  Widget build(BuildContext context) {
    final detailState = ref.watch(shipmentDetailViewModelProvider(widget.shipment));
    final viewModel = ref.read(shipmentDetailViewModelProvider(widget.shipment).notifier);
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isPaid ? AppColors.success.withValues(alpha: 0.3) : AppColors.neutral200,
          ),
          ...
          children: [
            ...
            if (!isPaid) ...[
              ...
              SizedBox(
                ...
                child: AppButton(
                  text: 'Pay Now',
                  isLoading: detailState.isInitiatingPayment || detailState.isLoadingInvoice,
